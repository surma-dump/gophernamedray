			...
			Object: gnr.NewUnion(
				...
				gnr.NewIntersection(
					&gnr.ColorChanger{
						Object: &object.AxisAlignedBox{
							Min: &gnr.Vector3f{-1, 0, -0.5},
							Max: &gnr.Vector3f{0, 1, 0.5},
						},
						NewColor: gnr.ColorRed,
					},
					&gnr.ColorChanger{
						Object: &object.Sphere{
							Center: &gnr.Vector3f{-0.5, 0.5, 0},
							Radius: 0.7,
						},
				...
				&gnr.Difference{
					Minuend: &gnr.ColorChanger{
						Object: &object.AxisAlignedBox{
							Min: &gnr.Vector3f{-2.5, 0, -0.5},
							Max: &gnr.Vector3f{-1.5, 1, 0.5},
						},
						NewColor: gnr.ColorMagenta,
					},
					Subtrahend: &gnr.ColorChanger{
						Object: &object.Sphere{
							Center: &gnr.Vector3f{-1.5, 1, -0.5},
							Radius: 0.5,
						},
						NewColor: gnr.ColorGreen,
					},
